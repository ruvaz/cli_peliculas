<template>
  <section class="section">
    ...
    <div class="columns is-mobile is-multiline">
      <Peli v-for="peli in pelis" :key="peli.id" :peli="peli" />
    </div>
  </section>
</template>
<script>
    ...
    return {
      pelis: [
        ...
        },
        {
          ...
          favoritos: "0",
          imagen:
            "https://m.media-amazon.com/images/M/MV5BNTc1YjhiNzktMjEyNS00YmNhLWExYjItZDhkNWJjZjYxOWZiXkEyXkFqcGdeQXVyNzkwMjQ5NzM@._V1_UX182_CR0,0,182,268_AL_.jpg",
          estreno: "1990",
          resumen:
